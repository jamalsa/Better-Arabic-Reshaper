...
public class ArabicReshaper{
	...
	/**
         * Array of array of chars contains arabic form for each letter of arabic.
         * Each array contains five elements which represents:
         * - Character unicode
         * - Isolated form
         * - Beginning form
         * - Middle form
	...
	public static char[][] ARABIC_GLPHIES=
		   {{ 1569,65152,65163,65164,65152,3 } , // 0621, HAMZA
			{ 1570,65153,65153,65154,65154,2 } , // 0622, ALEF_WITH_MADDA_ABOVE
			{ 1571,65155,65155,65156,65156,2 } , // 0623, ALEF_WITH_HAMZA_ABOVE
			{ 1572,65157,65157,65158,65158,2 } , // 0624, WAW_WITH_HAMZA_ABOVE
			{ 1573,65159,65159,65160,65160,2 } , // 0625, ALEF_WITH_HAMZA_BELOW
			{ 1575,65165,65165,65166,65166,2 } , // 0627, ALEF
			{ 1576,65167,65169,65170,65168,4 } , // 0628, BEH
			{ 1577,65171,65171,65172,65172,2 } , // 0629, TEH_MARBUTTA
			{ 1578,65173,65175,65176,65174,4 } , // 062A, TEH
			{ 1579,65177,65179,65180,65178,4 } , // 062B, THEH
			{ 1580,65181,65183,65184,65182,4 } , // 062C, JEEM
			{ 1581,65185,65187,65188,65186,4 } , // 062D, HAH
			{ 1582,65189,65191,65192,65190,4 } , // 062E, KHAH
			{ 1583,65193,65193,65194,65194,2 } , // 062F, DAL
			{ 1584,65195,65195,65196,65196,2 } , // 0630, THAL
			{ 1585,65197,65197,65198,65198,2 } , // 0631, REH
			{ 1586,65199,65199,65200,65200,2 } , // 0632, ZAIN
			{ 1587,65201,65203,65204,65202,4 } , // 0633, SEEN
			{ 1588,65205,65207,65208,65206,4 } , // 0634, SHEEN
			{ 1589,65209,65211,65212,65210,4 } , // 0635, SAD
			{ 1590,65213,65215,65216,65214,4 } , // 0636, DAD
			{ 1591,65217,65219,65218,65220,4 } , // 0637, TAH
			{ 1592,65221,65223,65222,65222,4 } , // 0638, ZAH
			{ 1593,65225,65227,65228,65226,4 } , // 0639, AIN
			{ 1594,65229,65231,65232,65230,4 } , // 063A, GHAIN
			{ 1601,65233,65235,65236,65234,4 } , // 0641, FEH
			{ 1602,65237,65239,65240,65238,4 } , // 0642, QAF
			{ 1603,65241,65243,65244,65242,4 } , // 0643, KAF
			{ 1604,65245,65247,65248,65246,4 } , // 0644, LAM
			{ 1605,65249,65251,65252,65250,4 } , // 0645, MEEM
			{ 1606,65253,65255,65256,65254,4 } , // 0646, NOON
			{ 1607,65257,65259,65260,65258,4 } , // 0647, HEH
			{ 1608,65261,65261,65262,65262,2 } , // 0648, WAW
			{ 1609,65263,65263,65264,65264,2 } , // 0649, ALEF_MAKSURA
			{ 1574,65161,65163,65163,65162,2 } , // 0626, YEH_WITH_HAMZA_ABOVE
			{ 1610,65265,65267,65268,65266,4 } }; // 064A, YEH
